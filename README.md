...
Choose a name for the secret, such as "**AS-IP-Blocklist-Remove-IPs-App-Registration-Secret**", and enter the App Registration Secret copied previously in the "**Value**" field. All other settings can be left as is. Click "**Create**". 
